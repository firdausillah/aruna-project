...
function Services() {
  ...
  return (
    <section id='services' className='py-28 bg-primary dark:bg-dark relative z-10'>
            ...
            <div key={index} className="mb-5 p-4 md:w-1/3">
              <div className="rounded-md overflow-hidden shadow-lg bg-primary group relative hover:scale-110 transition-all duration-300">
                  ...
                  <div className='bg-primary bg-opacity-90 absolute bottom-0 z-10 p-2 w-full'> 
                    <h3 className="font-semibold text-lg text-light mt-1">{data.title}</h3>
                    <div className='hidden group-hover:block mx-4 text-sm'>
                      <ul className='text-left'>
                        <li className='text-light line-clamp-2 text-ellipsis overflow-hidden'><span className='font-semibold'>Build With :</span> {data.build_with}</li>
                        <li className='text-light line-clamp-2 text-ellipsis overflow-hidden'><span className='font-semibold'>Year :</span> {data.year}</li>
                      </ul>
