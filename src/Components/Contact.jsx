        ...
        <div className="container">
            <div className="relative flex flex-wrap justify-center">
                <div className="w-ful self-center px-4 text-center">
                    ...
                    <a href="wa.me/6285212125044" className="font-semibold text-light bg-primary dark:text-primary dark:bg-light py-2 px-5 md:py-3 md:px-8 rounded-lg hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out text-sm md:text-base">Contact Me On Whatsapp</a>
